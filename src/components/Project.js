...
const Project = () => {
  return (
    <>
      <section className='my-28 px-5' id='projects'>
        ...
        <div className='my-7 space-y-24'>
          {projects.map((project, index) => (
            ...
            <img src={project.image} alt='project images' className={
              index % 2 === 0 ? 'w-full md:w-6/12 shadow-lg ' : 'w-full md:w-6/12 shadow-lg md:order-1'}/>
      ...
      <div className='mx-5'>
        <a href='https://github.com/DylanBarstow7' target='_blank' rel='noreferrer' className='bg-gray block shadow-lg uppercase border border-gray-500 rounded-lg text-center my-12 p-2 max-w-xs m-auto'>
